...
htmlhelp_basename = 'behave.example_doc'
...
latex_documents = [
  ('index', 'behave_example.tex', u'behave.example Documentation',
   u'Jens Engel', 'manual'),
]
...
man_pages = [
    ('index', 'behave_example', u'behave.example Documentation',
     [u'Jens Engel'], 1)
]
...
texinfo_documents = [
  ('index', 'behave_example', u'behave.example Documentation',
   u'Jens Engel', 'behave_example', 'One line description of project.',
   'Miscellaneous'),
]
...
pdf_documents = [
    ('index', u'behave.example', u'behave.example', u'Jens Engel'),
]
